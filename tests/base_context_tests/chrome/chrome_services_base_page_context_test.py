...
from tests.context_cases.services_page_context_case import ServicesPageContextCase
...
@allure.feature("Services Base Page")
@screenshot_on_fail()
class TestChromeHomeBasePageContext(ServicesPageContextCase):
